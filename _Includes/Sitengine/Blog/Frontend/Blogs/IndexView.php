...
abstract class Sitengine_Blog_Frontend_Blogs_IndexView extends Sitengine_View
{
    ...
    protected function _getMainSection()
    {
        try {
            ...
            $filter = $table->getFilterInstance(
            	...
            	array(
					'find' => Sitengine_Blog_Frontend_Blogs_Controller::PARAM_FILTER_BY_FIND,
					'reset' => Sitengine_Blog_Frontend_Blogs_Controller::PARAM_FILTER_RESET
				),
            ...
            */
            ...
            $query = array(
                Sitengine_Env::PARAM_SORT => $sorting->getActiveRule(),
                Sitengine_Env::PARAM_ORDER => $sorting->getActiveOrder(),
                Sitengine_Blog_Frontend_Blogs_Controller::PARAM_FILTER_RESET => 1
            );
