...
abstract class Sitengine_Blog_Backend_Blogs_ViewHelper extends Sitengine_View
{
    ...
    public function countPosts($id)
    {
    	try {
			...
			require_once 'Sitengine/Blog/Backend/Blogs/Exception.php';
			throw new Sitengine_Blog_Backend_Blogs_Exception('child count error', $exception);
		}
    }
