    ...
    protected function _getMainSection()
    {
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
				...
				$childActions['fileList'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getDictionary()->getFromFormGalleryView('childActionsSectionFilesIndex'),
				...
				$childActions['fileInsert'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getDictionary()->getFromFormGalleryView('childActionsSectionFilesInsert')
				);
                ...
                $title = $this->_controller->getDictionary()->getFromFormGalleryView('updateTitle').' ('.$title.')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranslationPayloads.php';
                ...
                $title = $this->_controller->getDictionary()->getFromFormGalleryView('insertTitle');
            }
            ...
            */
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getDictionary()->getFromFormGalleryView('contentSectionTitleDefault');
