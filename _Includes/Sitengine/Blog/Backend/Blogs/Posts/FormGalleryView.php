...
abstract class Sitengine_Blog_Backend_Blogs_Posts_FormGalleryView extends Sitengine_View {
        ...
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
				...
				$childActions['fileList'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getTranslate()->translate('formgalleryviewChildActionsSectionFilesIndex'),
					'postfix' => ' ('.$this->_controller->getViewHelper()->countFiles($stored['id']).')'
				);
				...
				$uri = $this->_controller->getRequest()->getBasePath().'/'.$route->assemble($args, true);
				$childActions['fileInsert'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getTranslate()->translate('formgalleryviewChildActionsSectionFilesInsert')
				);
                ...
                $title = $this->_controller->getTranslate()->translate('formgalleryviewUpdateTitle').' ('.$title.')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranscriptsPayloads.php';
                ...
                $title = $this->_controller->getTranslate()->translate('formgalleryviewInsertTitle');
            }
            ...
            */
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getTranslate()->translate('formgalleryviewContentSectionTitleDefault');
