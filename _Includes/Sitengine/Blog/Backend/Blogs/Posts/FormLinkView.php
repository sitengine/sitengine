        ...
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
                ...
                $title = $this->_controller->getDictionary()->getFromFormLinkView('updateTitle').' ('.Sitengine_String::truncate($title).')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranslationPayloads.php';
                ...
                $title = $this->_controller->getDictionary()->getFromFormLinkView('insertTitle');
            }
			...
			*/
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getDictionary()->getFromFormLinkView('contentSectionTitleDefault');
