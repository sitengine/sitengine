...
abstract class Sitengine_Blog_Backend_Blogs_Posts_FormLinkView extends Sitengine_View {
        ...
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
                ...
                $title = $this->_controller->getTranslate()->translate('formlinkviewUpdateTitle').' ('.Sitengine_String::truncate($title).')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranslationPayloads.php';
                ...
                $hiddens = array(
                    Sitengine_Env::PARAM_PAYLOAD_NAME => $payloads->getName(),
                    'type' => Sitengine_Blog_Posts_Table::TYPE_LINK
                    #Sitengine_Env::PARAM_PAGE => $valuePage,
                    #Sitengine_Env::PARAM_SORT => $valueSort,
                    #Sitengine_Env::PARAM_ORDER => $valueOrder,
                );
                ...
                $title = $this->_controller->getTranslate()->translate('formlinkviewInsertTitle');
            }
			...
			*/
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getTranslate()->translate('formlinkviewContentSectionTitleDefault');
