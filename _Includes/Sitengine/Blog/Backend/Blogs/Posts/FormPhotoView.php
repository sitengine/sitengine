...
abstract class Sitengine_Blog_Backend_Blogs_Posts_FormPhotoView extends Sitengine_View {
        ...
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
                ...
                $title = $this->_controller->getTranslate()->translate('formphotoviewUpdateTitle').' ('.$title.')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranslationPayloads.php';
                ...
                $hiddens = array(
                    Sitengine_Env::PARAM_PAYLOAD_NAME => $payloads->getName(),
                    'type' => Sitengine_Blog_Posts_Table::TYPE_PHOTO
                    #Sitengine_Env::PARAM_PAGE => $valuePage,
                    #Sitengine_Env::PARAM_SORT => $valueSort,
                    #Sitengine_Env::PARAM_ORDER => $valueOrder,
                );
                ...
                $title = $this->_controller->getTranslate()->translate('formphotoviewInsertTitle');
            }
            ...
            */
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getTranslate()->translate('formphotoviewContentSectionTitleDefault');
