...
abstract class Sitengine_Blog_Backend_Blogs_Posts_FormAudioView extends Sitengine_View {
        ...
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
                ...
                $route = $this->_controller->getFrontController()->getRouter()->getRoute(Sitengine_Blog_Backend_Front::ROUTE_BLOGS_POSTS_SHARP);
                $submitUri = $this->_controller->getRequest()->getBasePath().'/'.$route->assemble($args);
                
                $title = $stored['file1OriginalSource'];
                $title = $this->_controller->getDictionary()->getFromFormAudioView('updateTitle').' ('.$title.')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranslationPayloads.php';
                ...
                $hiddens = array(
                    Sitengine_Env::PARAM_PAYLOAD_NAME => $payloads->getName(),
                    'type' => Sitengine_Blog_Posts_Table::TYPE_AUDIO
                    #Sitengine_Env::PARAM_PAGE => $valuePage,
                    #Sitengine_Env::PARAM_SORT => $valueSort,
                    #Sitengine_Env::PARAM_ORDER => $valueOrder,
                );
                ...
                $title = $this->_controller->getDictionary()->getFromFormAudioView('insertTitle');
            }
            ...
            */
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getDictionary()->getFromFormAudioView('contentSectionTitleDefault');
