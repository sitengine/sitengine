...
abstract class Sitengine_Blog_Backend_Blogs_Posts_FormTextView extends Sitengine_View {
    ...
    protected function _getMainSection()
    {
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
				...
				$childActions['fileList'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getDictionary()->getFromFormTextView('childActionsSectionFilesIndex'),
				...
				$childActions['fileInsert'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getDictionary()->getFromFormTextView('childActionsSectionFilesInsert')
				);
                ...
                $title = $this->_controller->getDictionary()->getFromFormTextView('updateTitle').' ('.$title.')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranslationPayloads.php';
                ...
                $title = $this->_controller->getDictionary()->getFromFormTextView('insertTitle');
            }
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getDictionary()->getFromFormTextView('contentSectionTitleDefault');
