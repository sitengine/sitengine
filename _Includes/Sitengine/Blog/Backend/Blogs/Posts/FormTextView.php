    ...
    protected function _getMainSection()
    {
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
				...
				$childActions['fileList'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getTranslate()->translate('formtextviewChildActionsSectionFilesIndex'),
				...
				$childActions['fileInsert'] = array(
					'uri' => $uri,
					'label' => $this->_controller->getTranslate()->translate('formtextviewChildActionsSectionFilesInsert')
				);
            ...
            else
            {
                ...
                $title = $this->_controller->getTranslate()->translate('formtextviewInsertTitle');
            }
