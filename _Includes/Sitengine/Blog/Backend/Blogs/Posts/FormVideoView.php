        ...
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
                ...
                $title = $this->_controller->getDictionary()->getFromFormVideoView('updateTitle').' ('.Sitengine_String::truncate($title).')';
            }
            else
            {
            	require_once 'Sitengine/Form/TranslationPayloads.php';
                ...
                $title = $this->_controller->getDictionary()->getFromFormVideoView('insertTitle');
            }
			...
			*/
            ...
            ########################################################################
            $contentSectionTitle = $this->_controller->getDictionary()->getFromFormVideoView('contentSectionTitleDefault');
