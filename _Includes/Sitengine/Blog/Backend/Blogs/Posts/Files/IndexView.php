...
abstract class Sitengine_Blog_Backend_Blogs_Posts_Files_IndexView extends Sitengine_View {
    ...
    protected function _getMainSection()
    {
        try {
            ...
            $filter = $table->getFilterInstance(
            	...
            	array(
					'find' => Sitengine_Blog_Backend_Blogs_Posts_Files_Controller::PARAM_FILTER_BY_FIND,
					'type' => Sitengine_Blog_Backend_Blogs_Posts_Files_Controller::PARAM_FILTER_BY_TYPE,
					'reset' => Sitengine_Blog_Backend_Blogs_Posts_Files_Controller::PARAM_FILTER_RESET
				),
            ...
            $values = array_merge($this->_controller->getDictionary()->getFromFieldvals(Sitengine_Blog_Backend_Blogs_Posts_Files_Controller::PARAM_FILTER_BY_UID), $users);
            ...
            $values = array_merge($this->_controller->getDictionary()->getFromFieldvals(Sitengine_Blog_Backend_Blogs_Posts_Files_Controller::PARAM_FILTER_BY_GID), $groups);
            ...
            */
            ...
            $query = array(
                Sitengine_Env::PARAM_SORT => $sorting->getActiveRule(),
                Sitengine_Env::PARAM_ORDER => $sorting->getActiveOrder(),
                Sitengine_Blog_Backend_Blogs_Posts_Files_Controller::PARAM_FILTER_RESET => 1
            );
			...
			if($type == Sitengine_Blog_Posts_Table::TYPE_GALLERY) {
				$title = $this->_controller->getDictionary()->getFromLabels('listformPhotoTitle');
			}
			else {
				$title = $this->_controller->getDictionary()->getFromLabels('listformFileTitle');
			}
