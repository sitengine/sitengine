...
abstract class Sitengine_Blog_Backend_Blogs_Posts_Files_Entity
{
    ...
    public function getRow()
    {
    	if(!$this->_started) {
    		...
    		throw new Sitengine_Blog_Backend_Blogs_Posts_Files_Exception('entity not started');
    	}
        return $this->_row;
    }
    ...
    */
    ...
    public function start()
    {
        try {
            ...
            if(!$id) { $this->_row = null; }
				...
				if($row !== null) { $this->_row = $row; }
                    ...
                    require_once 'Sitengine/Blog/Backend/Blogs/Posts/Files/Exception.php';
                    throw new Sitengine_Blog_Backend_Blogs_Posts_Files_Exception(
                        'resource not found',
        ...
        catch (Sitengine_Blog_Backend_Blogs_Posts_Files_Exception $exception) {
            throw $exception;
        }
        catch (Exception $exception) {
            require_once 'Sitengine/Blog/Backend/Blogs/Posts/Files/Exception.php';
            throw new Sitengine_Blog_Backend_Blogs_Posts_Files_Exception('start entity error', $exception);
        }
    }
