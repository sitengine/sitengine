...
abstract class Sitengine_FormToMail_Default_Message extends Sitengine_View
{
    ...
    public function getData()
    {
    	try {
			return array(
				...
				#'DICTIONARY' => $this->_controller->getTranslate()->getData()
			);
		}
    ...
    public function build()
    {
    	try {
            ...
            $this->setSection('BODY', $this->_makeBody());
            return $this;
        }
        catch (Exception $exception) {
        	require_once 'Sitengine/FormToMail/Default/Exception.php';
    ...
    {
    	return 'mailToForm Subject';
    }
    
    
    
    protected function _makeBody()
    {
    	return array(
    		'firstname' => $this->_controller->getRequest()->getPost('firstname'),
    		'lastname' => $this->_controller->getRequest()->getPost('lastname'),
    		'email' => $this->_controller->getRequest()->getPost('email'),
    		'message' => $this->_controller->getRequest()->getPost('message')
    	);
    }
