...
abstract class Sitengine_Proto_Binaries_Goodies_Controller extends Sitengine_Controller_Action
{
    ...
    )
    {
        try {
            ...
            require_once 'Sitengine/Proto/Binaries/Goodies/Exception.php';
            throw new Sitengine_Proto_Binaries_Goodies_Exception('object instantiation error', $exception);
        }
    }
    ...
    protected function _mapInvokeArgs(array $invokeArgs)
    {
    	...
    	)
    	{
    		...
    		require_once 'Sitengine/Proto/Binaries/Goodies/Exception.php';
    		throw new Sitengine_Proto_Binaries_Goodies_Exception('invalid invoke args');
    	}
    }
    ...
    {
    	/*
    	$config = $config->protoFilesGoodiesController;
		...
		)
		{
			...
			require_once 'Sitengine/Proto/Binaries/Goodies/Exception.php';
			throw new Sitengine_Proto_Binaries_Goodies_Exception('action controller config error');
		}
		*/
    }
    ...
    protected function _start()
    {
    	try {
            ...
            require_once 'Sitengine/Proto/Binaries/Goodies/Exception.php';
            throw new Sitengine_Proto_Binaries_Goodies_Exception('init error', $exception);
        }
    }
    ...
    protected function _goToAction($action)
    {
    	...
    	if(is_callable(array($this, $handler))) {
    		...
    		require_once 'Sitengine/Proto/Binaries/Goodies/Exception.php';
    		throw new Sitengine_Proto_Binaries_Goodies_Exception('trying to forward to a non-existing action handler');
    	}
    }
    ...
    public function __call($a, $b)
    {
    	...
    	if($action === null) {
    		require_once 'Sitengine/Proto/Binaries/Goodies/Exception.php';
    		$exception = new Sitengine_Proto_Binaries_Goodies_Exception(
    ...
    protected function _binAction()
    {
    	try {
    		...
    		if(!$this->getPermiso()->getAcl()->privateAccessGranted($this->getFrontController()->getProtoPackage()->getAuthorizedGroups())) {
				require_once 'Sitengine/Proto/Binaries/Goodies/Exception.php';
				throw new Sitengine_Proto_Binaries_Goodies_Exception(
					'unauthorized',
            ...
            $table = $this->getFrontController()->getProtoPackage()->getGoodiesTable();
