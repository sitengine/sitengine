...
abstract class Sitengine_Proto_Binaries_Shouldies_Controller extends Sitengine_Controller_Action
{
    ...
    )
    {
        try {
            ...
            require_once 'Sitengine/Proto/Binaries/Shouldies/Exception.php';
            throw new Sitengine_Proto_Binaries_Shouldies_Exception('object instantiation error', $exception);
        }
    }
    ...
    protected function _mapInvokeArgs(array $invokeArgs)
    {
    	...
    	)
    	{
    		...
    		require_once 'Sitengine/Proto/Binaries/Shouldies/Exception.php';
    		throw new Sitengine_Proto_Binaries_Shouldies_Exception('invalid invoke args');
    	}
    }
    ...
    {
    	/*
    	$config = $config->protoFilesShouldiesController;
		...
		)
		{
			...
			require_once 'Sitengine/Proto/Binaries/Shouldies/Exception.php';
			throw new Sitengine_Proto_Binaries_Shouldies_Exception('action controller config error');
		}
		*/
    }
    ...
    protected function _start()
    {
    	try {
            ...
            require_once 'Sitengine/Proto/Binaries/Shouldies/Exception.php';
            throw new Sitengine_Proto_Binaries_Shouldies_Exception('init error', $exception);
        }
    }
    ...
    protected function _goToAction($action)
    {
    	...
    	if(is_callable(array($this, $handler))) {
    		...
    		require_once 'Sitengine/Proto/Binaries/Shouldies/Exception.php';
    		throw new Sitengine_Proto_Binaries_Shouldies_Exception('trying to forward to a non-existing action handler');
    	}
    }
    ...
    public function __call($a, $b)
    {
    	...
    	if($action === null) {
    		require_once 'Sitengine/Proto/Binaries/Shouldies/Exception.php';
    		$exception = new Sitengine_Proto_Binaries_Shouldies_Exception(
    ...
    protected function _binAction()
    {
    	try {
    		...
    		if(!$this->getPermiso()->getAcl()->privateAccessGranted($this->getFrontController()->getProtoPackage()->getAuthorizedGroups())) {
				require_once 'Sitengine/Proto/Binaries/Shouldies/Exception.php';
				throw new Sitengine_Proto_Binaries_Shouldies_Exception(
					'unauthorized',
			...
			$table = $this->getFrontController()->getProtoPackage()->getShouldiesTable();
