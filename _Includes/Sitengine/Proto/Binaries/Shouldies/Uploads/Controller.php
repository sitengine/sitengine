...
abstract class Sitengine_Proto_Binaries_Shouldies_Uploads_Controller extends Sitengine_Controller_Action
{
    ...
    )
    {
        try {
            ...
            require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
            throw new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception('object instantiation error', $exception);
        }
    }
    ...
    protected function _mapInvokeArgs(array $invokeArgs)
    {
    	...
    	)
    	{
    		...
    		require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
    		throw new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception('invalid invoke args');
    	}
    }
    ...
    {
    	/*
    	$config = $config->protoFilesShouldiesUploadsController;
		...
		)
		{
			...
			require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
			throw new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception('action controller config error');
		}
		*/
    }
    ...
    protected function _start()
    {
    	try {
            ...
            require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
            throw new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception('init error', $exception);
        }
    }
    ...
    protected function _goToAction($action)
    {
    	...
    	if(is_callable(array($this, $handler))) {
    		...
    		require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
    		throw new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception('trying to forward to a non-existing action handler');
    	}
    }
    ...
    public function __call($a, $b)
    {
    	...
    	if($action === null) {
    		require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
    		$exception = new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception(
    ...
    protected function _binAction()
    {
    	try {
    		...
    		if(!$this->getPermiso()->getAcl()->privateAccessGranted($this->getFrontController()->getProtoPackage()->getAuthorizedGroups())) {
				require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
				throw new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception(
					'unauthorized',
            ...
            if(!is_readable($path)) {
            	require_once 'Sitengine/Proto/Binaries/Shouldies/Uploads/Exception.php';
            	throw new Sitengine_Proto_Binaries_Shouldies_Uploads_Exception('file can not be downloaded', Sitengine_Env::ERROR_NOT_FOUND);
            }
