...
abstract class Sitengine_Proto_Binaries_Couldies_Controller extends Sitengine_Controller_Action
{
    ...
    )
    {
        try {
            ...
            throw new Sitengine_Proto_Binaries_Couldies_Exception('object instantiation error', $exception);
        }
    }
    ...
    protected function _mapInvokeArgs(array $invokeArgs)
    {
    	...
    	)
    	{
    		...
    		require_once 'Sitengine/Proto/Binaries/Couldies/Exception.php';
    		throw new Sitengine_Proto_Binaries_Couldies_Exception('invalid invoke args');
    	}
    }
    ...
    {
    	/*
    	$config = $config->protoFilesCouldiesController;
		...
		)
		{
			...
			require_once 'Sitengine/Proto/Binaries/Couldies/Exception.php';
			throw new Sitengine_Proto_Binaries_Couldies_Exception('action controller config error');
		}
		*/
    }
    ...
    protected function _goToAction($action)
    {
    	...
    	if(is_callable(array($this, $handler))) {
    		...
    		require_once 'Sitengine/Proto/Binaries/Couldies/Exception.php';
    		throw new Sitengine_Proto_Binaries_Couldies_Exception('trying to forward to a non-existing action handler');
    	}
    }
    ...
    protected function _binAction()
    {
    	try {
    		...
    		$table = $this->getFrontController()->getProtoPackage()->getCouldiesTable();
