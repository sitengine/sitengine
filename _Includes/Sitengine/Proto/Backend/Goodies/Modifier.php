...
abstract class Sitengine_Proto_Backend_Goodies_Modifier
{
    ...
    public function insert()
    {
        try {
            ...
            $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->handleInsertUploads($id);
            ...
            $data = array_merge($data, $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->getFileData());
            #Sitengine_Debug::print_r($data);
            $insertId = $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->insert($data);
            if(!$insertId)
            {
            	$error = $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->getError();
            ...
            throw new Sitengine_Proto_Backend_Goodies_Exception('insert error', $exception);
        }
    }
    ...
    public function update()
    {
        try {
            ...
            if(!$this->_checkInput()) { return null; }
            $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->handleUpdateUploads($id, $stored);
            ...
            $affectedRows = $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->update($data, $where);
            if(!$affectedRows)
            {
            	$error = $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->getError();
            	if($error === null) { return null; }
            ...
            require_once 'Sitengine/Proto/Backend/Goodies/Exception.php';
            throw new Sitengine_Proto_Backend_Goodies_Exception('update error', $exception);
        }
    }
    ...
    protected function _checkInput()
    {
        ...
        $validator->setMessage(
        	$this->_controller->getDictionary()->getFromHints('test'),
    ...
    public function delete($id)
    {
        try {
            ...
            return $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->delete($where);
        }
        catch (Exception $exception) {
            require_once 'Sitengine/Proto/Backend/Goodies/Exception.php';
            throw new Sitengine_Proto_Backend_Goodies_Exception('delete error', $exception);
        }
    }
    ...
    public function updateFromList($id, array $data)
    {
        try {
            ...
            require_once 'Sitengine/Sql.php';
    		$where = Sitengine_Sql::getWhereStatement($whereClauses, false);
            return $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->update($data, $where);
        }
        catch (Exception $exception) {
            require_once 'Sitengine/Proto/Backend/Goodies/Exception.php';
            throw new Sitengine_Proto_Backend_Goodies_Exception('update from list error', $exception);
        }
    }
    ...
    public function assignFromList($filename, array $data)
    {
        try {
        	# sanitize data
            foreach($data as $k => $v) {
                if(!preg_match('/^(type|cdate|mdate|gid)$/', $k)) {
                    unset($data[$k]);
                }
            }
			...
			$this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->handleFileImport($id, $sourcePath);
			$data = array_merge($data, $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->getFileData());
			#Sitengine_Debug::print_r($data);
			return $this->_controller->getFrontController()->getProtoPackage()->getGoodiesTable()->insertFileImport($data);
        }
        catch (Exception $exception) {
            require_once 'Sitengine/Proto/Backend/Goodies/Exception.php';
            throw new Sitengine_Proto_Backend_Goodies_Exception('assign from list error', $exception);
        }
    }
