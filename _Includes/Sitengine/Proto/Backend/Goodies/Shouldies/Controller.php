...
abstract class Sitengine_Proto_Backend_Goodies_Shouldies_Controller extends Sitengine_Controller_Action
{
    ...
    {
    	$this->_start();
    	if(!$this->getFrontController()->getProtoPackage()->tempDirPerUser()) { return $this->getFrontController()->getProtoPackage()->getShouldyTempDir(); }
        else {
        	$userTempDir = $this->getFrontController()->getProtoPackage()->getShouldyTempDir().'/'.$this->getPermiso()->getAuth()->getId();
    ...
    protected function _mapInvokeArgs(array $invokeArgs)
    {
    	...
    	)
    	{
    		...
    		require_once 'Sitengine/Proto/Backend/Goodies/Shouldies/Exception.php';
    		throw new Sitengine_Proto_Backend_Goodies_Shouldies_Exception('invalid invoke args');
    	}
    }
    ...
    {
    	$config = $config->{$this->getFrontController()->getConfigName()}->backend->goodiesShouldiesController;
		...
		)
		{
			...
			require_once 'Sitengine/Proto/Backend/Goodies/Shouldies/Exception.php';
			throw new Sitengine_Proto_Backend_Goodies_Shouldies_Exception('action controller config error');
		}
    }
    ...
    protected function _getTranslateInstance()
    {
		...
		$en = array(
			...
			$this->getEnv()->getIncludesDir().'/Sitengine/Proto/Backend/Goodies/Shouldies/_Dictionary/en.xml',
    ...
    protected function _start()
    {
    	try {
            ...
            require_once 'Sitengine/Proto/Backend/Goodies/Shouldies/Exception.php';
            throw new Sitengine_Proto_Backend_Goodies_Shouldies_Exception('init error', $exception);
        }
    }
    ...
    protected function _goToAction($action)
    {
    	...
    	if(is_callable(array($this, $handler))) {
    		...
    		require_once 'Sitengine/Proto/Backend/Goodies/Shouldies/Exception.php';
    		throw new Sitengine_Proto_Backend_Goodies_Shouldies_Exception('trying to forward to a non-existing action handler');
    	}
    }
    ...
    protected function _getResourceToActionMappings()
    {
    	return array(
    		...
    		Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INDEX
    		),
    		Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES_NEW => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INSERT,
    			Sitengine_Env::METHOD_POST => self::ACTION_DOINSERT
    		),
    		Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES_BATCH => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INDEX,
    			Sitengine_Env::METHOD_PUT => self::ACTION_DOBATCHUPDATE,
    			Sitengine_Env::METHOD_DELETE => self::ACTION_DOBATCHDELETE
    		),
    		Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES_SHARP => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_UPDATE,
    			Sitengine_Env::METHOD_PUT => self::ACTION_DOUPDATE
    		),
    		Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES_UPLOAD => array(
    		...
    		Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES_ASSIGN => array(
    ...
    public function factoryAction()
    {
    	...
    	{
    		require_once 'Sitengine/Proto/Backend/Goodies/Shouldies/Exception.php';
    		$exception = new Sitengine_Proto_Backend_Goodies_Shouldies_Exception(
    ...
    protected function _doUpdateAction()
    {
        try {
            ...
            */
			...
			$route = $this->getFrontController()->getRouter()->getRoute(Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES_SHARP);
        ...
        try {
            ...
            */
            ...
            if(is_null($data)) {
                ...
                $route = $this->getFrontController()->getRouter()->getRoute(Sitengine_Proto_Backend_Front::ROUTE_GOODIES_SHOULDIES);
