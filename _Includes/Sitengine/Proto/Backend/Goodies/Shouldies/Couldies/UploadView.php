...
abstract class Sitengine_Proto_Backend_Goodies_Shouldies_Couldies_UploadView extends Sitengine_View {
    ...
    protected function _getMainSection()
    {
        try {
			...
			$submitUri .= '?'.Sitengine_Env::PARAM_SESSIONID.'='.Zend_Session::getId();
			#print $submitUri;
