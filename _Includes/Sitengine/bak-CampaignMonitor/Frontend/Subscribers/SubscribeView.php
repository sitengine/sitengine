...
abstract class Sitengine_CampaignMonitor_Frontend_Subscribers_SubscribeView extends Sitengine_View
{
    ...
    public function build()
    {
        try {
			...
			$page->fetch($this->_controller->getSitemapPathSubscribeView());
