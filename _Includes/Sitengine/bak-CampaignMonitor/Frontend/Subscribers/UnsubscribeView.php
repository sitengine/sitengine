...
abstract class Sitengine_CampaignMonitor_Frontend_Subscribers_UnsubscribeView extends Sitengine_View
{
    ...
    public function build()
    {
        try {
			...
			$page->fetch($this->_controller->getSitemapPathUnsubscribeView());
