...
abstract class Sitengine_CampaignMonitor_Frontend_Subscribers_ConfirmOptinView extends Sitengine_View
{
    ...
    {
    	if(isset($config['controller']) && $config['controller'] instanceof Sitengine_CampaignMonitor_Frontend_Subscribers_Controller)
    	{
    ...
    public function build()
    {
        try {
			...
			$page->fetch($this->_controller->getSitemapPathConfirmOptinView());
        	...
        	throw new Sitengine_CampaignMonitor_Frontend_Subscribers_Exception('build page error', $exception);
        }
    }
    ...
    protected function _getMainSection()
    {
        try {
			...
			require_once 'Sitengine/CampaignMonitor/Frontend/Subscribers/Exception.php';
			throw new Sitengine_CampaignMonitor_Frontend_Subscribers_Exception('list page error', $exception);
		}
    }
}
