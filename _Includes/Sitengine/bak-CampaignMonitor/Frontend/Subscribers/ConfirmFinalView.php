...
abstract class Sitengine_CampaignMonitor_Frontend_Subscribers_ConfirmFinalView extends Sitengine_View
{
    ...
    public function build()
    {
        try {
			...
			$page->fetch($this->_controller->getSitemapPathConfirmFinalView());
