...
class Sitengine_Translations
{
    ...
    */
    ...
    {
    	return $this->_translations[$this->_index];
    }
    ...
    {
        return $this->_translations[$this->_defaultIndex];
    }
    ...
    {
        $index = array_search($symbol, $this->_translations);
