...
abstract class Sitengine_Newsletter_Backend_Campaigns_Entity
{
    ...
    public function getRow()
    {
    	if(!$this->_started) {
    		...
    		throw new Sitengine_Newsletter_Backend_Campaigns_Exception('entity not started');
    	}
		return $this->_row;
    }
    ...
    public function start()
    {
        try {
        	...
        	if($row !== null) { $this->_row = $row; }
				...
				require_once 'Sitengine/Newsletter/Backend/Campaigns/Exception.php';
				throw new Sitengine_Newsletter_Backend_Campaigns_Exception(
                    'resource not found',
        ...
        catch (Sitengine_Newsletter_Backend_Campaigns_Exception $exception) {
            throw $exception;
        }
        catch (Exception $exception) {
            require_once 'Sitengine/Newsletter/Backend/Campaigns/Exception.php';
            throw new Sitengine_Newsletter_Backend_Campaigns_Exception('start entity error', $exception);
        }
    }
}
?>