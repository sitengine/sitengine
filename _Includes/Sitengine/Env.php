...
class Sitengine_Env
{
    ...
    const STATUS_NOT_SUPPORTED = 'notSupported';
    const STATUS_NOTFOUND = 'notFound';
    const STATUS_BADREQUEST = 'badRequest';
    const STATUS_ERROR = 'error';
    const STATUS_ERRORINPUT = 'errorInput';
    const STATUS_OKINPUT = 'okInput';
    const STATUS_ERRORIMPORT = 'errorImport';
    const STATUS_OKIMPORT = 'okImport';
    const STATUS_ERRORINSERT = 'errorInsert';
    const STATUS_OKINSERT = 'okInsert';
    const STATUS_ERRORUPDATE = 'errorUpdate';
    const STATUS_OKUPDATE = 'okUpdate';
    const STATUS_ERRORDELETE = 'errorDelete';
    const STATUS_OKDELETE = 'okDelete';
    const STATUS_ERRORUNLINK = 'errorUnlink';
    const STATUS_OKUNLINK = 'okUnlink';
    const STATUS_ERRORBATCHTRASH = 'errorBatchDelete';
    const STATUS_OKBATCHTRASH = 'okBatchDelete';
    const STATUS_ERRORBATCHUNLINK = 'errorBatchUnlink';
    const STATUS_OKBATCHUNLINK = 'okBatchUnlink';
    const STATUS_ERRORBATCHINSERT = 'errorBatchInsert';
    const STATUS_OKBATCHINSERT = 'okBatchInsert';
    const STATUS_ERRORBATCHUPDATE = 'errorBatchUpdate';
    const STATUS_OKBATCHUPDATE = 'okBatchUpdate';
    const STATUS_ERRORBATCHASSIGN = 'errorBatchAssign';
    const STATUS_OKBATCHASSIGN = 'okBatchAssign';
    const STATUS_UPLOAD_EXISTS = 'errorUploadExists';
    const STATUS_UPLOAD_SIZEEXCEEDED = 'errorUploadSizeExceeded';
    const STATUS_UPLOAD_INCOMPLETE = 'errorUploadIncomplete';
    const STATUS_UPLOAD_NOFILE = 'errorUploadNoFile';
    const STATUS_UPLOAD_ERROR = 'errorUpload';
    const HINT_INVALID_ACTION = 'invalidAction';
    const HINT_DATA_EXPIRED = 'dataExpired';
