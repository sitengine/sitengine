...
abstract class Sitengine_Permiso_Backend_Users_Memberships_Controller extends Sitengine_Controller_Action
{
    ...
    )
    {
        try {
			...
			$this->_templateIndexView = $this->getEnv()->getIncludesDir().'/Sitengine/Permiso/Backend/Users/Memberships/_Templates/IndexView.html';
			$this->_templateFormView = $this->getEnv()->getIncludesDir().'/Sitengine/Permiso/Backend/Users/Memberships/_Templates/FormView.html';
        }
        catch (Exception $exception) {
            require_once 'Sitengine/Permiso/Backend/Users/Memberships/Exception.php';
            throw new Sitengine_Permiso_Backend_Users_Memberships_Exception('object instantiation error', $exception);
        }
    }
    ...
    protected function _mapInvokeArgs(array $invokeArgs)
    {
    	...
    	)
    	{
    		...
    		require_once 'Sitengine/Permiso/Backend/Users/Memberships/Exception.php';
    		throw new Sitengine_Permiso_Backend_Users_Memberships_Exception('invalid invoke args');
    	}
    }
    ...
    {
    	$config = $config->{$this->getFrontController()->getConfigName()}->backend->usersMembershipsController;
		...
		)
		{
			...
			require_once 'Sitengine/Permiso/Backend/Users/Memberships/Exception.php';
			throw new Sitengine_Permiso_Backend_Users_Memberships_Exception('action controller config error');
		}
    }
    */
    ...
    protected function _getTranslateInstance()
    {
		...
		$en = array(
			...
			$this->getEnv()->getIncludesDir().'/Sitengine/Permiso/Backend/Users/Memberships/_Dictionary/en.xml',
    ...
    protected function _start()
    {
    	try {
            ...
            require_once 'Sitengine/Permiso/Backend/Users/Memberships/Exception.php';
            throw new Sitengine_Permiso_Backend_Users_Memberships_Exception('init error', $exception);
        }
    }
    ...
    protected function _goToAction($action)
    {
    	...
    	if(is_callable(array($this, $handler))) {
    		...
    		require_once 'Sitengine/Permiso/Backend/Users/Memberships/Exception.php';
    		throw new Sitengine_Permiso_Backend_Users_Memberships_Exception('trying to forward to a non-existing action handler');
    	}
    }
    ...
    protected function _getResourceToActionMappings()
    {
    	return array(
    		...
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS_MEMBERSHIPS => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INDEX
    		),
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS_MEMBERSHIPS_NEW => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INSERT,
    			Sitengine_Env::METHOD_POST => self::ACTION_DOINSERT
    		),
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS_MEMBERSHIPS_BATCH => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INDEX,
    			Sitengine_Env::METHOD_PUT => self::ACTION_DOBATCHUPDATE,
    			Sitengine_Env::METHOD_DELETE => self::ACTION_DOBATCHDELETE
    		),
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS_MEMBERSHIPS_SHARP => array(
    ...
    public function factoryAction()
    {
    	...
    	{
    		require_once 'Sitengine/Permiso/Backend/Users/Memberships/Exception.php';
    		$exception = new Sitengine_Permiso_Backend_Users_Memberships_Exception(
    ...
    protected function _doUpdateAction()
    {
        try {
            ...
            /*
            $tables = array(
                $this->getFrontController()->getPermisoPackage()->getUsersTableName() => 'READ',
            ...
            */
			...
			$route = $this->getFrontController()->getRouter()->getRoute(Sitengine_Permiso_Backend_Front::ROUTE_USERS_MEMBERSHIPS_SHARP);
