...
abstract class Sitengine_Permiso_Backend_Users_Controller extends Sitengine_Controller_Action
{
    ...
    const PARAM_FILTER_RESET = 'reset';
    ...
    )
    {
        try {
			...
			$this->_templateIndexView = $this->getEnv()->getIncludesDir().'/Sitengine/Permiso/Backend/Users/_Templates/IndexView.html';
			$this->_templateFormView = $this->getEnv()->getIncludesDir().'/Sitengine/Permiso/Backend/Users/_Templates/FormView.html';
        }
        catch (Exception $exception) {
            require_once 'Sitengine/Permiso/Backend/Users/Exception.php';
            throw new Sitengine_Permiso_Backend_Users_Exception('object instantiation error', $exception);
        }
    }
    ...
    protected function _mapInvokeArgs(array $invokeArgs)
    {
    	...
    	)
    	{
    		...
    		require_once 'Sitengine/Permiso/Backend/Users/Exception.php';
    		throw new Sitengine_Permiso_Backend_Users_Exception('invalid invoke args');
    	}
    }
    ...
    {
    	$config = $config->{$this->getFrontController()->getConfigName()}->backend->usersController;
		...
		)
		{
			...
			require_once 'Sitengine/Permiso/Backend/Users/Exception.php';
			throw new Sitengine_Permiso_Backend_Users_Exception('action controller config error');
		}
    }
    */
    ...
    protected function _start()
    {
    	try {
            ...
            require_once 'Sitengine/Permiso/Backend/Users/Exception.php';
            throw new Sitengine_Permiso_Backend_Users_Exception('init error', $exception);
        }
    }
    ...
    protected function _goToAction($action)
    {
    	...
    	if(is_callable(array($this, $handler))) {
    		...
    		require_once 'Sitengine/Permiso/Backend/Users/Exception.php';
    		throw new Sitengine_Permiso_Backend_Users_Exception('trying to forward to a non-existing action handler');
    	}
    }
    ...
    protected function _getRestMappings()
    {
    	return array(
    		...
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INDEX
    		),
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS_NEW => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INSERT,
    			Sitengine_Env::METHOD_POST => self::ACTION_DOINSERT
    		),
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS_BATCH => array(
    			Sitengine_Env::METHOD_GET => self::ACTION_INDEX,
    			Sitengine_Env::METHOD_PUT => self::ACTION_DOBATCHUPDATE,
    			Sitengine_Env::METHOD_DELETE => self::ACTION_DOBATCHDELETE
    		),
    		Sitengine_Permiso_Backend_Front::ROUTE_USERS_SHARP => array(
    ...
    protected function _doUpdateAction()
    {
        try {
            ...
            if(!Sitengine_Http::checkReferer()) {
                require_once 'Sitengine/Permiso/Backend/Users/Exception.php';
                throw new Sitengine_Permiso_Backend_Users_Exception('bad request', Sitengine_Env::ERROR_BAD_REQUEST);
            }
            /*
            $tables = array(
            ...
            */
			...
			$route = $this->getFrontController()->getRouter()->getRoute(Sitengine_Permiso_Backend_Front::ROUTE_USERS_SHARP);
    ...
    protected function _doInsertAction()
    {
        try {
			...
			$route = $this->getFrontController()->getRouter()->getRoute(Sitengine_Permiso_Backend_Front::ROUTE_USERS);
