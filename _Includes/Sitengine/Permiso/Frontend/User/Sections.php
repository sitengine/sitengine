...
abstract class Sitengine_Permiso_Frontend_User_Sections {
    ...
    public function makeLoginFormSection(array $hiddens = array())
    {
    	try {
			...
			throw new Sitengine_Permiso_Frontend_User_Exception('login form section error', $exception);
		}
    }
    */
    ...
    public function makeFormSection()
    {
        try {
            ...
            $inputMode
            	= ($this->_controller->getPermiso()->getAuth()->hasIdentity())
            	? Sitengine_Env::INPUTMODE_UPDATE
            	: Sitengine_Env::INPUTMODE_INSERT
            ;
