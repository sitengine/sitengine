...
class Sitengine_Permiso_Db_Users_Table extends Sitengine_Db_TableWithFiles
{
    ...
    public function __construct(array $config = array())
    {
    	if(
			...
			$this->_configs[self::AVATAR_ORIGINAL] = array(
				'dir' => $this->_permiso->getUserAvatarOriginalDir(),
				'mode' => 0644
			);
			$this->_configs[self::AVATAR_THUMB] = array(
				'dir' => $this->_permiso->getUserAvatarThumbDir(),
				'mode' => 0644,
				'length' => 160,
				'method' => 'width',
				'jpgQuality' => 100
    ...
    public function complementRow(Sitengine_Permiso_Db_Users_Row $row)
    {
		$data = $row->toArray();
		$data = $this->_complementFileData($data, self::AVATAR_ORIGINAL, $this->_permiso->getUserAvatarOriginalDir());
		$data = $this->_complementFileData($data, self::AVATAR_THUMB, $this->_permiso->getUserAvatarThumbDir());
		return $data;
    }
