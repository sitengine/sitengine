...
abstract class Sitengine_Permiso_Backend_Users_Controller extends Sitengine_Controller_Action
{
    ...
    public function getExceptionInstance($message, $p2 = null, $p3 = null, $priority = null)
    {
        ...
        return new Sitengine_Permiso_Backend_Users_Exception($message, $p2, $p3, $priority);
    }
    ...
    public function doUpdateAction()
    {
        try {
            ...
            /*
            $tables = array(
                $this->getPermiso()->getUsersTableName() => 'WRITE',
                $this->getPermiso()->getGroupsTableName() => 'READ',
                $this->getPermiso()->getMembershipsTableName() => 'READ'
            );
            # lock tables
    ...
    public function doMeAction()
    {
        try {
            ...
            $this->getDatabase()->getConnection()->exec($q);
            */
            $this->getEntity()->start($this->getPermiso()->getAuth()->getId());
        ...
        try {
            ...
            */
            ...
            $membershipRecord =
            	...
            	->getControllerInstance(Sitengine_Permiso_Backend_Front::CONTROLLER_USERS_MEMBERSHIPS)
            	->getRecord()
            ;
            ...
            if(sizeof($rows) > 0) {
                ...
                */
                foreach($rows as $id => $v) {
                    $affectedRows = $modifier->delete($id, $membershipRecord);
