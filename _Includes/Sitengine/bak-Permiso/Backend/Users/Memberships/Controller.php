...
abstract class Sitengine_Permiso_Backend_Users_Memberships_Controller extends Sitengine_Controller_Action
{
    ...
    public function getExceptionInstance($message, $p2 = null, $p3 = null, $priority = null)
    {
        ...
        return new Sitengine_Permiso_Backend_Users_Memberships_Exception($message, $p2, $p3, $priority);
    }
    ...
    protected function _getDictionaryInstance()
    {
        ...
        $dictionary->addFiles(
            ...
            array(
				...
				$this->getEnv()->getIncludesDir().'/Sitengine/Permiso/Backend/Users/Memberships/_Dictionary/de.xml',
