...
abstract class Sitengine_Permiso_Backend_Users_Memberships_Record extends Sitengine_Record {
    ...
    public function __construct(
    	Sitengine_Permiso_Backend_Users_Memberships_Controller $controller
    )
    {
        $this->_controller = $controller;
        parent::__construct($this->_controller->getDatabase());
        $this->_table = $this->_controller->getPermiso()->getMembershipsTableName();
    }
