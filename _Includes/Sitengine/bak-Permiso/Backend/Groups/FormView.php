        ...
        try {
            ...
            if($this->_inputMode == Sitengine_Env::INPUTMODE_UPDATE)
            {
                ...
                */
                ...
                $args = array(
                	Sitengine_Env::PARAM_ID => $stored['id'],
                	Sitengine_Env::PARAM_ACTION => Sitengine_Permiso_Backend_Groups_Controller::ACTION_DOUPDATE
                );
                $route = $this->_controller->getFrontController()->getRouter()->getRoute(Sitengine_Permiso_Backend_Front::ROUTE_GROUPS);
            ...
            else
            {
                ...
                $args = array(
                	Sitengine_Env::PARAM_ACTION => Sitengine_Permiso_Backend_Groups_Controller::ACTION_DOINSERT
                );
                $route = $this->_controller->getFrontController()->getRouter()->getRoute(Sitengine_Permiso_Backend_Front::ROUTE_GROUPS);
                $submitUri = $this->_controller->getRequest()->getBasePath().'/'.$route->assemble($args, true);
