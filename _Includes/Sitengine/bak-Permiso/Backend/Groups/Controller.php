...
abstract class Sitengine_Permiso_Backend_Groups_Controller extends Sitengine_Controller_Action
{
    ...
    public function getExceptionInstance($message, $p2 = null, $p3 = null, $priority = null)
    {
        ...
        return new Sitengine_Permiso_Backend_Groups_Exception($message, $p2, $p3, $priority);
    }
    ...
    protected function _getDictionaryInstance()
    {
        ...
        $dictionary->addFiles(
            ...
            array(
				...
				$this->getEnv()->getIncludesDir().'/Sitengine/Env/_Dictionary/de.xml',
				$this->getEnv()->getIncludesDir().'/Sitengine/Permiso/Backend/Groups/_Dictionary/de.xml',
    ...
    public function doUpdateAction()
    {
        try {
            ...
            /*
            $tables = array(
                $this->getPermiso()->getGroupsTableName() => 'WRITE'
            );
            # lock tables
            ...
            */
            $this->getEntity()->start($this->getRequest()->get(Sitengine_Env::PARAM_ID));
        ...
        try {
            ...
            */
            ...
            $memberRecord =
            	...
            	->getControllerInstance(Sitengine_Permiso_Backend_Front::CONTROLLER_GROUPS_MEMBERS)
            	->getRecord()
            ;
            $deleted = 0;
            ...
            if(sizeof($rows) > 0) {
                ...
                */
                foreach($rows as $id => $v) {
                    $affectedRows = $modifier->delete($id, $memberRecord);
