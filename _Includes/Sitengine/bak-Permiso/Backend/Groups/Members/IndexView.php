...
abstract class Sitengine_Permiso_Backend_Groups_Members_IndexView extends Sitengine_View {
    ...
    public function build()
    {
        try {
            ...
            $this->setSection('MEMBERLIST', $this->_getMainSection());
            return $this;
        }
    ...
    protected function _getMainSection()
    {
        try {
            ...
            $e = new Sitengine_Form_Element(Sitengine_Permiso_Backend_Groups_Members_Controller::PARAM_FILTER_BY_FIND, $filter->getVal(Sitengine_Permiso_Backend_Groups_Members_Controller::PARAM_FILTER_BY_FIND));
            $e->setId('filter'.Sitengine_Permiso_Backend_Groups_Members_Controller::PARAM_FILTER_BY_FIND);
            $e->setClass('filterText');
            $filter->setElement(Sitengine_Permiso_Backend_Groups_Members_Controller::PARAM_FILTER_BY_FIND, $e->getText(20));
            ...
            $q .= ' WHERE';
            $q .= ' m.groupId = "'.$this->_controller->getEntity()->getAncestorId().'"';
            $q .= ' AND m.userId = u.id';
            $q .= $filter->getSql();
            ...
            $args = array(
            	Sitengine_Env::PARAM_ANCESTORID => $this->_controller->getEntity()->getAncestorId(),
            	Sitengine_Env::PARAM_ACTION => Sitengine_Permiso_Backend_Groups_Members_Controller::ACTION_DOBATCHDELETE
            );
            $route = $this->_controller->getFrontController()->getRouter()->getRoute(Sitengine_Permiso_Backend_Front::ROUTE_GROUPS_MEMBERS);
            ...
            $args = array(
            	Sitengine_Env::PARAM_ANCESTORID => $this->_controller->getEntity()->getAncestorId(),
            	Sitengine_Env::PARAM_ACTION => Sitengine_Permiso_Backend_Groups_Members_Controller::ACTION_DOBATCHUPDATE
            );
            $route = $this->_controller->getFrontController()->getRouter()->getRoute(Sitengine_Permiso_Backend_Front::ROUTE_GROUPS_MEMBERS);
